...
export const ui = {
  ...
  kz: {
    ...
    "reg.ageConfirm":
      "Мен 16 жастан асқанымды растаймын және мінез-құлық ережелерімен келісемін.",
    "reg.ageConfirmPre": "Мен 16 жастан асқанымды растаймын және",
    "reg.codeOfConduct": "мінез-құлық ережелерімен",
    "reg.register": "Тіркелу",
    "reg.pdfOnly": "Тек PDF файлдар рұқсат етіледі",
    "reg.cvSizeLimit": "CV файлы 2 МБ-тан аспауы керек",
    "reg.pleaseConfirmAge":
      "Жасыңыздың 16-дан асқанын және мінез-құлық ережелерімен келісетініңізді растаңыз",
