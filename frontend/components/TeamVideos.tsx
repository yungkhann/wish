...
const TeamVideos = () => {
  return (
    <>
      <div className="mx-auto flex flex-col items-center bg-black py-20">
        <div className="inline-flex h-auto w-full max-w-4xl flex-col items-center justify-start gap-10 rounded-tl-3xl rounded-tr-md rounded-br-3xl rounded-bl-md bg-gradient-to-r from-black/20 via-black/20 to-black/20 px-2 pt-8 pb-10 shadow-[0px_0px_40px_0px_rgba(119,22,208,0.40)] sm:max-w-3xl sm:px-4 md:max-w-4xl md:px-8 lg:max-w-5xl lg:px-16 xl:max-w-6xl">
          <h1 className="mt-2 text-center font-['Marcellus'] text-3xl font-normal tracking-widest text-purple-600 uppercase sm:text-4xl md:text-5xl lg:text-6xl">
            Team Videos
          </h1>
          ...
          {videos.map((url, idx) => (
            <div key={url} className="flex w-full flex-col items-center gap-8">
              ...
              <div className="w-full max-w-2xl px-2 text-justify">
                <span className="font-['Marcellus'] text-xl font-normal text-purple-600 sm:text-2xl md:text-3xl lg:text-4xl">
                  Team Project {idx + 1}
                </span>
                <span className="font-['Marcellus'] text-xl font-normal text-white sm:text-2xl md:text-3xl lg:text-4xl">
                  {" "}
          ...
          <div className="mt-8 flex w-full flex-col items-center gap-6">
            <div className="w-full max-w-2xl text-center font-['Marcellus'] text-2xl font-normal text-white sm:text-3xl md:text-4xl">
              Useful Links:
            </div>
            <div className="w-full max-w-2xl space-y-2 text-center font-['Marcellus'] text-lg font-normal text-purple-500 sm:text-xl md:text-2xl">
