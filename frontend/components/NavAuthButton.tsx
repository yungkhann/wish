...
export default function NavAuthButton({ mobile }: { mobile?: boolean }) {
  ...
  if (mobile) {
    return (
      <a
        href={href}
        className="relative mt-4 flex h-[54px] w-full max-w-[210px] items-center justify-center rounded-[30px_3.75px_30px_3.75px] bg-[radial-gradient(ellipse_at_center,rgba(0,0,0,0.5)_0%,#9A44E9_100%)] shadow-[0px_0px_45px_0px_rgba(119,22,208,0.6)]"
      >
