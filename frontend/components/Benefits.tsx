        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-6 sm:max-w-6xl sm:gap-8 md:grid-cols-2 lg:grid-cols-2">
          {([1, 2, 3, 4, 5, 6, 7, 8] as const).map((n) => {
            ...
            return (
              <div
                key={n}
                className={`flex h-auto min-h-[100px] items-center justify-center rounded-2xl bg-linear-to-r from-black/20 via-black/20 to-black/20 px-4 py-5 shadow-[0px_0px_60px_0px_rgba(119,22,208,0.60)] sm:h-36 sm:px-12 sm:py-0 lg:h-44 ${
                  isOdd
